...
candidate 的 build、pack、isolated install 与完整 Project Gate consumer 只能证明 artifact 及核心用途可交付；它们不能证明 npm registry 的名称控制权、认证主体、目标版本可用性、公开 legal materials、不可逆 publish 写入或发布后从 registry 安装的结果。

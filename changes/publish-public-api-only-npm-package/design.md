...
| --- | --- | --- | --- |
| 1. Candidate, gate and documentation handoff | [`establish-npm-package-candidate-and-quality-dogfood`](../archive/establish-npm-package-candidate-and-quality-dogfood/) + [`replace-workspace-verifier-with-project-gate`](../archive/replace-workspace-verifier-with-project-gate/) + [`align-project-gate-with-native-check-authoring`](../align-project-gate-with-native-check-authoring/) + [`ship-public-package-api-documentation`](../ship-public-package-api-documentation/) | exact tarball and matching preparation receipt, `gate-handoff.md`, `gate-optimization-handoff.md`, `package-api-documentation-handoff.md`, complete Project Gate consumer evidence | authoritative binding, package runtime, declarations, README/API guide and current Gate behavior are independently verified |

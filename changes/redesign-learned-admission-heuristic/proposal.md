...
- 消费[Gate 资源配置](../../docs/tooling/project-gate.md#并发与优先级)（提交 `b30477b6`）和[虚拟平台](../../docs/tooling/workspace.md#virtual-admission-workbench)（提交 `f7e9f353`）的稳定输入，先运行基线、定位反例，再提出和比较小范围候选。

...
| [add-project-run-diagnostic-logging](add-project-run-diagnostic-logging/) | 一次性详细 Project Run core 人读日志。 | 外部默认关闭，仓库 quality/Gate 默认开启；Check-specific 信息继续使用 final data/Record，不建立 Check logger 或稳定日志解析。 |

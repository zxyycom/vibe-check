...
export function runPackageApiDocumentationCli(
  ...
  return Object.freeze({
    diagnostics: Object.freeze([
      `package API documentation is stale: ${stalePaths.join(", ")}; run bun scripts/docs/package-api-docs/index.ts --write`
    ]),
    exitCode: 1
  });
}
...
function parseMode(argv: readonly string[]): PackageApiDocumentationMode {
  ...
  throw new Error("usage: bun scripts/docs/package-api-docs/index.ts --check|--write");
}

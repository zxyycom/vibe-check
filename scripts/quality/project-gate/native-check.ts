import { validateDecisionRecords, type DecisionValidationResult } from "../../decision-records.ts";
import { validateDocs, type DocsValidationTask } from "../../docs/validate.ts";
import { checkTestEvidence, type ProjectTestEvidenceReport } from "../../test-evidence/cli.ts";

...
export const PACKAGE_TRANSLATED_ANALYZER_PROVENANCE_PATH = "licenses/lizard-1.23.0-provenance.json";
export const PACKAGE_LIZARD_MIT_LICENSE_PATH = "licenses/Lizard-1.23.0-MIT.txt";
export const PACKAGE_LIZARD_APACHE_LICENSE_PATH = "licenses/Lizard-1.23.0-lizard.py-Apache-2.0.txt";
...
export const PACKAGE_THIRD_PARTY_NOTICES_SHA256 =
  "87608ea9a2aa0ce5d344203d4744b8041753b6203771cc0733e43beebfa3bcb0";
export const PACKAGE_TRANSLATED_ANALYZER_PROVENANCE_SHA256 =
  "6ca298bfc00241c0c651c06f6207c4bdf1be6898452c171769879c18d4debae8";

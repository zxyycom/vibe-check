...
## Case FM-ANALYZER-CORE-001: translated in-memory analyzer primitives preserve their Lizard 1.23 processor boundary
...
## Case FM-ANALYZER-READERS-B-001: translated script readers preserve Lizard 1.23 reader-local function metrics
...
- Python, GDScript, Ruby, Lua, Perl, and R readers preserve the checked-in Lizard 1.23 normal and edge oracle observations for every reader-owned suffix, including case-distinct R suffix spellings.

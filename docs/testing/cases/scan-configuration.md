...
Entities:
- `bun|src/product/public-contract/current.test.ts|current public contract > owns exactly the definition-facing names, defaults, and operational identifiers`
...
- `bun|src/product/definition/project.test.ts|Project Definition > provides frozen chainable built-in adjustments without expanding defaults`
- `bun|src/product/definition/project.test.ts|Project Definition > rejects unknown descriptor adjustments without reading accessors or freezing inputs`

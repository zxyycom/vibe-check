...
- Under `strict + noUncheckedIndexedAccess`, installed callback declarations preserve non-empty and discriminated tuple structure while retaining `unknown` leaf uncertainty.

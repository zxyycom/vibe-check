...
- Artifact construction and audit produce one package with the approved documentation inventory, public declarations and root exports, readable ESM layout, and exact declared production dependencies.
...
- The ancestry-external installation carries the exact generated package README, and the projected package API documentation runtime examples execute against that exact candidate package.

...
- Engine 在任何 executor work 前验证静态 Task identity、dependency、scope membership、activation/terminal relation、cap 和 signed admission priority；它以一个 root budget 处理 dependency、mutex 与 generic scope cap。

...
## Case FM-ANALYZER-READERS-E-001: Go-like reader 保持 Lizard 1.23 的 observable metrics
...
- `bun|src/package-checks/function-metrics/analyzer/readers/golike-readers.test.ts|Go-like readers preserve all Lizard 1.23 upstream language scenarios`

Proves:

- Go、Rust、Scala、Solidity、Zig、Swift 与 Kotlin 的全部当前 suffix、normal/edge oracle fixture 保持 Lizard 1.23 function name、range、NLOC、CCN 与 parameter count。

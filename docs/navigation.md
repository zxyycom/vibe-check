...
| 修改 Project Definition、`defineConfig` defaults、quality semantics、validation、normalization、precedence 或 legacy JSON migration                    | [Configuration](configuration.md)、[编码规范](coding-style.md)                                   | [Scan Scope](scan-scope.md) 与 Project Definition tests                                                                     |

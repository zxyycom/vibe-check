...
| 修改开发脚本、Project Gate、annotation consumer、共享 toolkit、docs validator 或 quality wrapper | [脚本工具](script-tooling.md)、[编码规范](coding-style.md) | 对应 `scripts/**`、正式产品入口及其 consumer contract |

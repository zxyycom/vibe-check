...
`not-applicable` / `unavailable` 带受控 reason，前者可以省略 reason。Aggregation、output status、duration、terminal
messages、visibility 和 progress presentation 不属于 machine fields。

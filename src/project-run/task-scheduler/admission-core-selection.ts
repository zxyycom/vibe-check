...
import { isScopeInactiveForCore } from "./admission-core-selection-query.ts";
import { selectionIndexForSeed } from "./admission-core-selection-seed.ts";
import { transitionIndexedSelection } from "./admission-core-selection-transition.ts";

...
const EvidenceRefSchema = Type.Union([
  Type.Object({ checkId: StableIdString, kind: Type.Literal("check") }, {
    additionalProperties: false
  }),
...
export const MACHINE_RECORD_V3_SCHEMA = Type.Object({
  ...
  fields: Type.Record(Type.String(), Type.Union([
    ...
    description: "Dynamic record fields constrained by the owning published Check record-type descriptor."
  }),

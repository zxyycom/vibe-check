...
const MIGRATION_MESSAGE =
  "Vibe Check JSON configuration and Product CLI scan/init are retired. Create a TypeScript Project Definition and a bound project Run, then call the project Run directly.";

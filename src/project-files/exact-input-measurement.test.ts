...
import { acceptExactInputMeasurements } from "./exact-input-measurement.ts";
...
describe("scoped measurement acceptance", () => {
  it("validates declared source paths without inspecting payload shape", () => {
    ...
    const unapproved = acceptExactInputMeasurements(
      [
        {
          payload,
    ...
    const pathless = acceptExactInputMeasurements(
      [
        {
          payload,
          sourcePaths: []

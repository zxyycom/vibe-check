...
import type { DuplicateDetectionOptions } from "../../definition/default-checks.ts";
import type { CheckExecutionContext, CheckResult } from "../../definition/custom-check.ts";
import type { DuplicationScannerDependency } from "../measurement/scanners/dependencies.ts";
import { buildFingerprints, collectScanFiles } from "../input/files.ts";
import { classifyFiles } from "../configuration/code-areas.ts";
import { getGitSha } from "../input/project-revision.ts";

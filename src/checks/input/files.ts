...
import { buildFingerprint, isExcluded } from "../configuration/code-areas.ts";
...
import type { CodeAreaFileMap, CodeAreaFingerprint } from "../configuration/metric-contract.ts";
